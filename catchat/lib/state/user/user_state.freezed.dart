...
abstract class $UserStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<String, dynamic> userInfo, String userId});
}
...
class _$UserStateImpl with DiagnosticableTreeMixin implements _UserState {
  const _$UserStateImpl(
      {final Map<String, dynamic> userInfo = const {}, this.userId = ''})
      : _userInfo = userInfo;
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserState(userInfo: $userInfo, userId: $userId)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_userInfo), userId);
...
abstract class _UserState implements UserState {
  const factory _UserState(
      ...
      final String userId}) = _$UserStateImpl;
